  ...
  print() {
    return /*html*/`
            <div class="pt-[20px]">
             ...
             <a href="/admin/new/add_news"><button type="button" class="w-[186px] h-[252px] bg-gray-500">+ <br> add news</button></a>
             ${data.map((post) => /*html*/`
            <div class="border-[1px] border-slate-900 py-2 px-3"> 
            <a href="/admin/news/${post.id}" class="hover:text-stone-500" >
             <div>
